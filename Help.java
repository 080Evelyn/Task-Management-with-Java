...
public class Help extends JPanel{
	...
	public Help(Base b) {
		base = b;
		q1 = new JLabel("How does Task-Timer improve my productivity?");
		q2 = new JLabel("How do I use Task-Timer?");
